...
# UI Elements
st.markdown('<div class="badge-container"><div class="agent-badge"><span style="display:inline-block; width:8px; height:8px; border-radius:50%; background:#22c55e; margin-right:6px;"></span>Agent: ABLBL JD Transformer AI Agent</div></div>', unsafe_allow_index=True)
st.markdown('<h1 class="main-title">ABLBL JD Transformer AI Agent</h1>', unsafe_allow_index=True)
st.markdown('<p class="subtitle">Transform legacy JDs into official, full-bleed ABLBL Role Playbook PDFs instantly.</p>', unsafe_allow_index=True)
...
# Branded Footer
st.markdown("<footer>ABLBL JD Transformer AI Agent • Aditya Birla Lifestyle Brands Limited</footer>", unsafe_allow_index=True)
