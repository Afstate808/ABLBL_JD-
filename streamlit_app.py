...
try:
    from app import (
        ...
        GROQ_API_KEY,
        generate_all_icons,
        summarize_preferred_qualification
    )
...
preferred_qualification = st.text_area(
    "Preferred Qualification (Optional):",
    placeholder="Type any preferred qualifications, certifications, or custom candidate requirements here...",
    help="The agent will format and summarize these as professional bullet points under a dedicated section at the end of the playbook."
).strip()
...
if st.button("Generate Playbooks 🚀", use_container_width=True):
    if not uploaded_files:
        ...
        if preferred_qualification:
            pref_qual_list = summarize_preferred_qualification(preferred_qualification, use_api_key)
